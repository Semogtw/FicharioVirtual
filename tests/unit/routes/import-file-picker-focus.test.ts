...
describe('image import file picker focus', () => {
	it('surfaces keyboard focus on the visible file-picker controls', () => {
		expect(source).toContain('.file-button:focus-within');
		expect(source).toContain('.camera-button:focus-within');
