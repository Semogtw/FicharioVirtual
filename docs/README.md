...
- [`PUBLIC_PORTFOLIO_PLAN.md`](PUBLIC_PORTFOLIO_PLAN.md) — plano canônico da versão pública completa usando a mesma aplicação/infraestrutura, cadastro self-service, isolamento por RLS e roteamento server-side de providers por perfil de usuário.
